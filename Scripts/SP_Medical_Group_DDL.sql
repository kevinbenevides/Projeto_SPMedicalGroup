...
--Criando a Tabela de Tipo de Usuários
CREATE TABLE TIPO_USUARIOS(
	ID INT IDENTITY PRIMARY KEY
	,NOME VARCHAR(250) UNIQUE NOT NULL  
);

--Criando a Tabela das Areas de Atuações dos Médicos
CREATE TABLE AREAS_ATUACOES(
	ID INT IDENTITY PRIMARY KEY
	,NOME VARCHAR(250) UNIQUE NOT NULL
);

--Criando a Tabela das Clinicas
...
--Criando a Tabela de Prontuários
...
------------------------------------------------------
--Desconsidere esse comandos úteis kkkkk
